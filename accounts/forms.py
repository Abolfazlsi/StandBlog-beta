...
class RegisterForm(forms.Form):
    ...
    email = forms.EmailField(widget=forms.EmailInput(attrs={"class": "login__input"}))
    password1 = forms.CharField(widget=forms.PasswordInput(attrs={"class": "login__input"}))
    password2 = forms.CharField(widget=forms.PasswordInput(attrs={"class": "login__input"}))
